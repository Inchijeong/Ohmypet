...
public class FreeBoardDAO {
	...
	public FreeBoardDM selectBoardByNo(int no) {
		...
		try {
			...
			StringBuffer sql = new StringBuffer();
			sql.append("select no, title, content, id, category_val, pw , reg_date, file_path "
					+ " from t97_freeboard "
					+ " where no=? ");
			/*
			...
			sql.append(" where no=?, a.category_val = b.category_val ");
