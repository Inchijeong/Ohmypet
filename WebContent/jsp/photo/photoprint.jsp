...
<script >
	function sharing(){
		window.open("http://www.facebook.com/sharer/sharer.php?u=http://192.168.0.28:8000/ohmypet/com/omp/photo/detail?no=${dm.no}");		
	}
...
<div class="form-group"> 
 ...
 <button type="button"><a href="/ohmypet/com/omp/photo/delete?no=${dm.no}">삭제</a></button>
