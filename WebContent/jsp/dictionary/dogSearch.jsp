...
<body>
	...
	<c:import url="/jsp/dictionary/dictionaryList.jsp" />
	    ...
	    <c:forEach var="dogName" items="${dogList}">
	    	<div class="result">
	    	<a class="btn btn-default btn-lg" href="${pageContext.request.contextPath}/com/omp/dictionary/controller/dictionary?dogName=<c:out value="${dogName}" />"> <c:out value="${dogName}" /></a>
	    	</div>
	    </c:forEach>
	  </div>
