...
action = "${pageContext.request.contextPath}com/omp/freeboard/controller/freeseupdate">
 <input type="hidden" name="no" value="${board.no}" />
 <table width="300" border="0" cellspacing="2" cellpadding="0">
            <tr class="txt01">
                <td height="25">&nbsp;&nbsp;글 수정하기</td>
            </tr>
        </table>
...
<textarea class="form-control" rows="20" maxlength="500" value="text" name="content">${board.content}</textarea><br>
...
<input type="text" placeholder="비밀번호"  name="pw"><br><br>
...
<a class="btn btn-default" name = "list" href="${pageContext.request.contextPath}/com/omp/freeboard/controller/freeupdateForm?no=${board.no}">수정</a>
