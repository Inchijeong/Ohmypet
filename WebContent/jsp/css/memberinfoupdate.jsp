		...
		<form action="/ohmypet/com/omp/common/controller/membershipupdate">
	 		...
	 		H.P : <select name='phbrand'>
 					 ...
 					 <option value='KT' >KT</option>
						...
						<input class="a" type="text" name="phon1" value="${phon[0]}" >-<input class="a" type="text" name="phon2" value="${phon[1]}" >-<input class="a" type="text" name="phon3" value="${phon[2]}" >
	 		<br>
	 		<br>
	 		...
	 		<br>
	 		<br>
	 		<button type="submit" onclick="alert('개인정보가 수정되었습니다. 다시 로그인 해주세요');">정보변경하기</button>
